...
$id = $_GET['id'];
$village = $conn->query("SELECT F.Detail,FoodName,F.ImgFood1,F.DetailSp,F.note,F.Knowlege, 
    ...
    <div class="container-main">
      <div class="box-main">
        ...
        <div class="text-main">
          ...
          <h1 class="text-left mt-3"><b>เกร็ดความรู้<?php echo $ingredients['FoodName'] ?></b></h1>
          <p class="text-respon"><?php echo nl2br($ingredients['Knowlege']); ?></p>
        </div>
      </div>
    </div>
    <!--  -->
